...
void LoopClosing::SetLocalMapper(LocalMapping *pLocalMapper1, LocalMapping *pLocalMapper2)
{
    mpLocalMapper1=pLocalMapper1;
    mpLocalMapper2=pLocalMapper1;
    mpLocalMapper=mpLocalMapper1;
    localMapperSwitch=true;
}
...
void LoopClosing::Run()
{
    ...
    while(1)
    {
        ...
        //----------------------------
        localMapperSwitch=!localMapperSwitch;
        mpLocalMapper = mpLocalMapper1;
        if(localMapperSwitch) mpLocalMapper = mpLocalMapper2;
